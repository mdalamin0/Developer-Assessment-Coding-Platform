...
import { AssessmentStatus, AttemptStatus, ProblemType, ResultStatus, Role, UserStatus } from "../../../generated/prisma/enums";
import { IUserQuery } from "../admin/admin.interface";
...
const getAllCandidates = async (query: IUserQuery) => {
